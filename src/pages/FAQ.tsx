...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Yes! Many of our products can be personalised with engravings or custom messages. Simply choose the customisation options available on the product page during checkout to create a truly unique and meaningful gift."
      },
      {
        q: "Do you offer gift wrapping and can I add a personal message?",
        a: "Yes, we offer gift wrapping options and the ability to include a personalised message with your order. These options can be selected when choosing each gift."
      },
      {
      ...
      },
      {
        ...
        a: "Our products are designed with unique craftsmanship and personalisation options to make a lasting impression. Plus, our customer reviews highlight the joy our gifts bring to their recipients, helping to reassure your choice."
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "Can I preview my engraving before purchase?",
        a: "Yes, we offer a preview tool for certain products so you can see how your engraving will look before finalizing your order. This ensures you’re happy with the design before it’s made."
      },
      {
    ...
    questions: [
      {
        ...
        a: "We have been operating successfully as a passion-driven project turned into a globally recognized brand known for quality craftsmanship and innovative designs."
      },
      {
        q: "What is your return policy?",
        a: "We offer a hassle-free return and exchange policy. If you’re not satisfied with your purchase, you can initiate a return within 30 days of receiving your order."
      },
      {
      ...
      },
      {
        ...
        a: "Yes, we offer special pricing for bulk and corporate orders. Please contact us directly for more information on how we can accommodate your needs."
      },
      {
